    ...
    <div style="width: 98%; margin-left: 10px;">
        <table id="example" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th style="text-align: center;width: 2%">充值金额</th>
                <th style="text-align: center;width: 2%">描述</th>
                <th style="text-align: center;width: 4%">状态</th>
                <th style="text-align: center;width: 2%">流水号</th>
    ...
    $(document).ready(function () {
        ...
        datatable  =  $('#example').DataTable({
            ...
            "columns": [
                ...
                {"data":function (obj) {
                        if (obj.status==0){
                            return "<span><center>待付款</center></span>"
                        }else if (obj.status==1){
                            return "<span><center>充值中</center></span>"
                        }else if (obj.status==2){
                            return "<span><center>充值成功</center></span>"
                        }else {
