    ...
    <form action="" name="form" method="post" class="form form-horizontal"
        ...
        <div class="cl pd-5  mt-10">
				<span class="l" style="margin-left:5px;">
				 <a class="btn btn-primary radius" onclick="open_layer('添加轮播图','admbanneradd','900','450')" href="javascript:;">
    ...
    <div style="width: 98%; margin-left: 10px">
        <table id="example" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th style="text-align: center;width: 10%">图片ID</th>
                <th style="text-align: center;width: 10%">图片</th>
<%--                <th style="text-align: center;width: 10%">URL</th>--%>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            ...
            "columns": [
                ...
                { "data": "id" },
                { "data": function(obj){
                        /*return "<span><center><img style='max-width:80px' src='upload/"+obj.address+"' onclick='imgcli(this)'/></center></span>"*/
                        return "<span><center><img style='max-width:80px' src='../upload/"+obj.address+"' onclick=\"open_layer('查看','../upload/"+obj.address+"','600','450')\"/></center></span>"
                    }
                },
                ...
                { "data": function(obj){
                        if(obj.status==0){
                            return "<a onclick=\"open_layer('编辑','admbanneredit?id="+obj.id+"','900','450')\">编辑</a>&nbsp;" +
    ...
    //     layer_show('图片',$(obj).attr("src"),'1200','800');
    // }
    function  imgcli() {
        console.log("111")
        var _this = $(this);
