    ...
    <div style="width: 98%; margin-left: 10px">
        <table id="example" class="table table-striped table-bordered" style="width: 1400px;">
            ...
            <tr>
                ...
                <th style="text-align: center;width: 3%">身份证号</th>
                <th style="text-align: center;width: 1%">手机号</th>
                <th style="text-align: center;width: 1%">姓名</th>
                <th style="text-align: center;width: 1%">身份证正面</th>
                <th style="text-align: center;width: 1%">身份证反面</th>
                <th style="text-align: center;width: 1%">审核状态</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        datatable  =  $('#example').DataTable({
            "ajax":{
                "url": "adminuserywylistajax",
                "type": "post",
                "data": function(d) {
                    d.is_mech = 3;
                    d.check_status = $('#types option:selected').val();
                }
            },
            ...
            "columns": [
                ...
                { "data": function(obj){
                        if(obj.check_status==0) {
                            return "<span><center><a onclick=\"endobj(" + obj.id + ")\">通过</a></center></span>"
                        }
                    }
                }
            ],
