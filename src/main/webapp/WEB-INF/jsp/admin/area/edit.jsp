            ...
            <div class="content">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input name="name" placeholder="" value="${area.name}"></td>
                        </td>
                    </tr>
                    <tr>
                        <td class="item-name"><label>排序:</label></td>
                        <td><input name="sort" placeholder="默认0" value="${area.sort}"></td>
                    </tr>
                    <tr>
...
<script>
    ...
    function tijiao(){
        ...
        if(files.length == 0) {
            $.ajax( {
                type : 'POST',
                url : 'adminareaeditajax',
                data : {id:id,pic:null,sort:sort,name:name},
        ...
        xhr.addEventListener("readystatechange", function() {
            ...
            if (result.status != 200) { //error
                ...
                $.ajax( {
                    type : 'POST',
                    url : 'adminareaeditajax',
                    data : {id:id,pic:pic,sort:sort,name:name},
                    success : function(data) {
                        if(data.code==100){
                            alert("提交成功");
                            parent.reload();
