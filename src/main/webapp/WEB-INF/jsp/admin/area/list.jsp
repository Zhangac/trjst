    ...
    <form action="" name="form" method="post" class="form form-horizontal"
        ...
        <div class="cl pd-5  mt-10">
				<span class="l" style="margin-left:5px;">
				 <a class="btn btn-primary radius" onclick="open_layer('添加','adminareaadd','900','450')" href="javascript:;">
    ...
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            ...
            "columns": [
                ...
                { "data": "name" },
                { "data": function(obj){
                        return "<span><center><img style='max-width:80px' src='../upload/"+obj.head+"' onclick=\"open_layer('查看','../upload/"+obj.head+"','600','450')\"/></center></span>"
                    }
                },
                { "data": "sort" },
                { "data":  function(obj){
                ...
                { "data": function(obj){
                        if(obj.status==0){
                            return "<a onclick=\"open_layer('编辑','adminareaedit?id="+obj.id+"','900','450')\">编辑</a>&nbsp;" +
                                   "<a onclick=\"startobj("+obj.id+")\">启用</a>&nbsp;" /*+
                                "<a onclick=\"deleteobj(" + obj.id + ")\">删除</a></center></span>"*/
                        }else if(obj.status==1){
                            return  "<a onclick=\"open_layer('编辑','adminareaedit?id="+obj.id+"','900','450')\">编辑</a>&nbsp;" +
                                    "<a onclick=\"endobj("+obj.id+")\">停用</a>&nbsp;"/* +
                                "<a onclick=\"deleteobj(" + obj.id + ")\">删除</a></center></span>"*/
                        }
                    }
                }
