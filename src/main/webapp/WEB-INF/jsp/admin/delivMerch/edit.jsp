            ...
            <div class="content">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input name="name" placeholder="" value="${assort.name}"></td>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="row clearfix">
                    ...
                    <div class="form-controls col-xs-8 col-sm-9 skin-minimal">
                        <div class="check-box">
                            <input type="checkbox" id="isadd" name="isadd" value="">
                            <label for="isadd">发布商品&nbsp;</label>
                        </div>
                        <input name="delivery_id" placeholder="" value="${delivery_id}" <%--type="hidden"--%>>
                        <c:forEach items="${mi}" var="type">
                            <p><input type="checkbox" name="check" value="${type.id}"><label>${type.merchant_name}</label></p>
                        </c:forEach>
                    </div>
                </div>
                <div class="footer">
