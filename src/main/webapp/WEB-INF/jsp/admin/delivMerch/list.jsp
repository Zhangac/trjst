...
<%--				 <a class="btn btn-primary radius" onclick="open_layer('添加','adminDelivMerchadd?delivery_id='+${delivery_id},'650','400')" href="javascript:;">--%>
