...
<body>
                    ...
                    <div class="text-c" >
                        <form class="Huiform" method="post" action="" target="_self" >
                            <div class="panel" >
                                <div class="panel-body">
                                    <div class="text-l">
                                        <input type="text" name="dvname" id="dvname" placeholder="姓名" style="width: 250px" class="input-text">
    ...
    <div style="width: 98%; margin-left: 10px">
        <table id="example" class="table table-striped table-bordered" style="width: 1600px;">
            <thead>
            <tr>
                ...
                <th style="text-align: center;width: 10%">身份证</th>
                <th style="text-align: center;width: 5%">车牌号</th>
                <th style="text-align: center;width: 5%">地址</th>
                <th style="text-align: center;width: 5%">驾驶证</th>
                <th style="text-align: center;width: 5%">行驶证</th>
                <th style="text-align: center;width: 5%">手持身份证</th>
                <th style="text-align: center;width: 5%">车辆照片</th>
                <th style="text-align: center;width: 5%">合同签名</th>
    ...
    $(document).ready(function() {
        ...
        datatable  =  $('#example').DataTable({
            ...
            "columns": [
                ...
                { "data": "address" },
                { "data": function(obj){
                        return "<span><center><img style='max-width:80px' src='../upload/"+obj.js_cert+"' onclick=\"open_layer('查看','../upload/"+obj.js_cert+"','600','450')\"/></center></span>"
                    }
                },
                { "data": function(obj){
                        return "<span><center><img style='max-width:80px' src='../upload/"+obj.xs_cert+"' onclick=\"open_layer('查看','../upload/"+obj.xs_cert+"','600','450')\"/></center></span>"
                    }
                },
                { "data": function(obj){
                        return "<span><center><img style='max-width:80px' src='../upload/"+obj.sc_card+"' onclick=\"open_layer('查看','../upload/"+obj.sc_card+"','600','450')\"/></center></span>"
                    }
                },
                { "data": function(obj){
                        return "<span><center><img style='max-width:80px' src='../upload/"+obj.car_image+"' onclick=\"open_layer('查看','../upload/"+obj.car_image+"','600','450')\"/></center></span>"
                    }
                },
                { "data": function(obj){
                ...
                { "data": function(obj){
                        return "<span><center><a onclick=\"open_layer('查看','adminDelivMerchlist?id="+obj.id+"','1000','500')\">查看</a>&nbsp;" +
