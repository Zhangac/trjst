    ...
    <div style="width: 98%; margin-left: 10px">
        <table id="example" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th style="text-align: center;width: 5%">到手金额</th>
                <%--<th style="text-align: center;width: 10%">提现类型</th>--%>
                ...
                <th style="text-align: center;width: 10%">开户行</th>
                <th style="text-align: center;width: 10%">银行</th>
    ...
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            ...
            "columns": [
                ...
                /*{ "data":  function(obj){
                        if(obj.type==1){
                            return "<span><center>支付宝</center></span>"
                        }else if(obj.type==2){
                            return "<span><center>微信</center></span>"
                        }else if(obj.type==3){
                            return "<span><center>银行卡</center></span>"
                        }else {
                ...
                { "data":  function(obj){
                        if(obj.status==1){
                            return "<span><center>提现中</center></span>"
                        }else if(obj.status==2){
                            return "<span><center>提现成功</center></span>"
                        }else if(obj.status==3){
                            return "<span><center>提现失败</center></span>"
                        }else {
                            return "<span><center></center></span>"
                        }
                    }
                ...
                { "data": function(obj){
                        if(obj.status==1){
                            return "<a onclick=\"startobj("+obj.id+")\">通过</a>&nbsp;" +
                                   "<a onclick=\"endobj("+obj.id+")\">不通过</a>&nbsp;<a onclick=\"deleteobj(" + obj.id + ")\">删除</a></center></span>"
                        }else{
                            return  "<a onclick=\"deleteobj(" + obj.id + ")\">删除</a></center></span>"
                        }
                    }
                }
            ],
