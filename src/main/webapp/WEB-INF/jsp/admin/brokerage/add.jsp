        ...
        <form  id="form"  action="" method= "post">
            <div class="content">
                <table>
                    ...
                    <tr>
                        <td class="item-name"><label>入驻金额:</label></td>
                        <td><input name="brokerage_amount" placeholder="" value="${bk.brokerage_amount}"></td>
                    </tr>
                    <tr>
                        <td class="item-name"><label>类型:</label></td>
                        <td><select class="select" id="type" name="type" size="1">
                            ...
                            <option value="6" <c:if test="${level==6}"> selected="selected"</c:if>>其他</option>--%>
                        </select></td>
                    </tr>
                </table>
                <div class="footer">
