    ...
    <form action="" name="form" method="post" class="form form-horizontal"
        ...
        <div class="cl pd-5  mt-10">
				<span class="l" style="margin-left:5px;">
				 <a class="btn btn-primary radius" onclick="open_layer('添加','adminBrokerageadd','900','450')" href="javascript:;">
    ...
    <div style="width: 98%; margin-left: 10px">
        <table id="example" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th style="text-align: center;width: 25%">入驻金额</th>
    ...
    $(document).ready(function() {
        ...
        $('#example').DataTable( {
            ...
            "columns": [
                ...
                { "data": function(obj){
                        return "<span><center><a onclick=\"open_layer('设置佣金','adminBrokerageedit?id="+obj.id+"','900','450')\">设置佣金</a>&nbsp;<a onclick=\"deleteobj(" + obj.id + ")\">删除</a></center></span>"
                    }
                }
            ],
            "columnDefs": [
