                            ...
                            <div class="panel" >
                                <div class="panel-body">
                                    <div class="text-l">
                                        ...
                                        <br />
                                        <span>配送员：</span>
                                        <input type="text" name="delivery_name" id="delivery_name" placeholder="配送员" style="width: 250px" class="input-text">
                                        <br />
                                        <br />
                                        <span>日&nbsp;&nbsp;&nbsp;期：</span>
                                        <input type="text"
...
<script type="text/javascript">
            ...
            "columns": [
                ...
                { "data":  function(obj){
                        if(obj.pay_status==0){
                            ...
                            return "<span><center>已完成</center></span>"
                        }else {
    ...
    function download(){
        ...
        var url="adminOrderExcel/download_excel?order_no="
            +order_no+"&pay_status="+pay_status+"&delivery_name="+delivery_name;
        window.open(url);
    }
</script>
</body>
