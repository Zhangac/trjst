...
public class AdminAssortController {
    ...
    @ResponseBody
    public Map adminassorteditajax(Integer id, String name, Integer sort, BigDecimal yongjin,String yuliu){
        return adminAssortService.edit(id,name,sort,yongjin,yuliu);
    }
